...
function multiply(a, b) { //eslint-disable-line
    var c = a*b
    //given 5,9 should return [45, 'the multiply of 5 and 9 is 45,']
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
   var summ= sum(a,b);
  var summ2= sum(summ[0],c)
   var multiplying =multiply(a,b);
   var multiplying2=multiply(multiplying[0],c) 
   
return [summ2[0], multiplying2[0] ,a + " and " + b + " and " + c + " sum to " + summ2[0] +".", "The product of " + a + " and " + b + " and " + c + " is " + multiplying2[0] + "."]; 
}
